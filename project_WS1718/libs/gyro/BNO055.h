...
private:
    ...
    int translatePinWiringPi(int pin);

public:

    BNO055(int address, int reset);
    virtual ~BNO055();
    ...
    int getAccelerometerID();
    int getMagnetometerID();
    int getGyroID();

    int getKalibrierungSys();
    int getKalibrierungGyro();
    int getKalibrierungAcc();
    int getKalibrierungMag();

    double getEulerHeading();
    double getEulerRoll();
